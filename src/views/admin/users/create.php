        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="card-apple">
                    <div class="card-body">
                        <form id="createUserForm" action="<?= Config::APP_URL ?>/admin/users/create" method="POST" class="needs-validation" novalidate>
            ...
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                ...
                <div class="card-apple-glass">
                    <div class="card-body">
                        ...
                        <a href="<?= Config::APP_URL ?>/help/admin-guide" class="btn btn-sm btn-apple-glass w-100">
